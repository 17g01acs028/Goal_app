                    ...
                    <CardContent>
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
                            <div className="grid gap-2">
                                ...
                                <Input id="first-name" placeholder="Firstname" value={(userData as User)?.firstName}  name="firstName" required />
                            </div>
                            <div className="grid gap-2">
                                <Label htmlFor="last-name">Last name</Label>
                                <Input id="last-name" placeholder="Lastname" name="lastName" value={(userData as User)?.lastName} required />
                            </div>
                            <div className="grid gap-2">
                                <Label htmlFor="location">Location</Label>
                                <Input id="location" placeholder="Location" name="location" value={(userData as User)?.location} required />
                            </div>
                            <div className="grid gap-2">
                                <Label htmlFor="occupation">Occupation</Label>
                                <Input id="occupation" placeholder="Occupation" name="occupation" value={userData?.occupation || ""} required />
                            </div>
                            <div className="grid gap-2">
                                <Label htmlFor="email">Email</Label>
                                <Input id="email" placeholder="Email" name="email" value={userData?.email || ""} required />
                            </div>
                            <div className="grid gap-2">
                                <Label htmlFor="role">Role</Label>
                                <Select name='role' value={(userData as User)?.role} >
                                    <SelectTrigger >
                            ...
                            <div className="grid gap-2">
                                ...
                                <Select name='status' value={(userData as User)?.status} onValueChange={handleStatusChange}>
                                    <SelectTrigger >
